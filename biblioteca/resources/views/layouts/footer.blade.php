...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="">HDS Studio</a>.</strong>
</footer>
</div><!-- ./wrapper -->
...
<!-- jQuery 2.1.3 -->
<script src="{{ asset('dist/img/user4-128x128.jpg')}}"></script>
<!-- jQuery UI 1.11.2 -->
<script src="{{ asset('dist/img/user4-128x128.jpg')}}" type="text/javascript"></script>
